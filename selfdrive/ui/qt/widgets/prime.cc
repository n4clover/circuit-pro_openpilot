  ...
  hlayout->addLayout(vlayout, 1);
  {
    ...
    QLabel *instructions = new QLabel(R"(
      <ol type='1' style='margin-left: 15px;'>
        <li style='margin-bottom: 50px;'>Go to https://192.168.1.25:4430/useradmin/overview on your phone</li>
...
SetupWidget::SetupWidget(QWidget* parent) : QFrame(parent) {
  ...
  QLabel* registrationDescription = new QLabel("Pair your device at https://192.168.1.25:4430/useradmin");
