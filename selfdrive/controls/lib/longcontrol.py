  ...
  stopping_condition = (v_ego < 2.0 and cruise_standstill) or \
                       (v_ego < CP.vEgoStopping and
                        ((v_pid < stopping_target_speed and v_target < stopping_target_speed) or
                         brake_pressed))
  stopping_condition = stopping_condition or v_ego < 1.0 or (v_ego < 2.46 and v_target < 4.) #Cleaner method discoverd to accomplish fix on older version of neokii - JPR
