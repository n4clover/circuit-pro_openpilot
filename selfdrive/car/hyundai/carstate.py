...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp2, cp_cam):
    ...
    ret.steeringPressedSPAS = abs(ret.steeringTorque) > STEER_THRESHOLD + (200 * ANGLE_FACTOR) if self.mdps11_stat == (4 or 5) else abs(ret.steeringTorque) > STEER_THRESHOLD
