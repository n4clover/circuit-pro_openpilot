...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    ...
    gas_max_v = [CarControllerParams.ACCEL_MAX, 2., 1.8, 1.5, 1.1, 0.7, 0.4]
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
   ...
   #Longitudinal Tune and logic for car tune
    ...
    ret.stoppingDecelRate = 0.75  # brake_travel/s while trying to stop
 ...
 #Tune To base Kona EV tune off of.
    ...
    # kia
      ...
      ret.longitudinalTuning.kpBP = [0, 10. * CV.KPH_TO_MS, 20. * CV.KPH_TO_MS, 40. * CV.KPH_TO_MS, 70. * CV.KPH_TO_MS, 100. * CV.KPH_TO_MS, 130. * CV.KPH_TO_MS]
      ret.longitudinalTuning.kpV = [1.26, 1.16, 1.07, 0.98, 0.92, 0.87, 0.82]
      ret.longitudinalTuning.kiBP = [0., 130. * CV.KPH_TO_MS]
